...
type ExchangeServiceClient interface {
	GetExchangeRates(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ExchangeRatesOutput, error)
}
...
func (c *exchangeServiceClient) GetExchangeRates(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ExchangeRatesOutput, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ExchangeRatesOutput)
...
type ExchangeServiceServer interface {
	GetExchangeRates(context.Context, *emptypb.Empty) (*ExchangeRatesOutput, error)
...
func (UnimplementedExchangeServiceServer) GetExchangeRates(context.Context, *emptypb.Empty) (*ExchangeRatesOutput, error) {
...
func _ExchangeService_GetExchangeRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).GetExchangeRates(ctx, req.(*emptypb.Empty))
	}
